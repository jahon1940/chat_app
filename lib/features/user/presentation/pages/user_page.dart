...
import 'package:empty_feature_folder/features/user/bloc/user_bloc.dart';
...
class _UserPageState extends State<UserPage> with UserPageMixin {
  @override
          ...
          body: ListView(
            children: [
              ...
              state.file == null
                ...
                onPressed: () {
                  context.read<UserBloc>().add(GetImageEvent());
                },
              ),
              Padding(
